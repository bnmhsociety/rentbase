    ...
    <div className="page">
      ...
      <main className="container success">
        <div className="card">
          ...
          {request.received_email_sent_at ? (
            <div className="notice ok" style={{ marginTop: 14 }}>Un email de confirmation a été envoyé à {request.email} avec le récapitulatif.</div>
          ) : (
            <div className="notice wait" style={{ marginTop: 14 }}>Votre demande est bien enregistrée. L’email automatique peut prendre quelques minutes ou dépendre de la configuration email du site.</div>
          )}
