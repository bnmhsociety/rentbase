...
export async function sendEmail({ to, subject, html }) {
  ...
  if (!apiKey) return { skipped: true, reason: "RESEND_API_KEY manquant dans Vercel" };
  if (!from) return { skipped: true, reason: "MAIL_FROM manquant dans Vercel" };
  if (!recipient) return { skipped: true, reason: "Email client manquant" };
